...
class ChronopostTransport(Transport):
    ...
    CHRONOPOST_TRACKING_WS = "https://ws.chronopost.fr/tracking-cxf/TrackingServiceWS"
    ...
    def send_tracking_request(self, body, action):
        """Send request to Chronopost Tracking WS."""
        response = requests.get(
            self.CHRONOPOST_TRACKING_WS+"/"+action, params=body
        )
